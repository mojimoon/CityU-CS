...
- Data **mining**
- **Pattern evaluation** (identifies truly interesting patterns based on given measures)
- **Knowledge presentation** (visualization and presentation of mined knowledge to users)
...
$$s(X \Rightarrow Z) = \frac{\sigma(X \cup Z)}{\sigma(X)}$$
