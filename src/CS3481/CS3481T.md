...
- Support for {e}: $s({e}) = \frac{8}{10} = 0.8$
- Support for {b,d}: $s({b,d}) = \frac{2}{10} = 0.2$
- Support for {b,d,e}: $s({b,d,e}) = \frac{2}{10} = 0.2$

(b) Confidence for the association rules:

- Confidence for {b,d}→{e}: $c({b,d} \rightarrow {e}) = \frac{s({b,d,e})}{s({b,d})} = \frac{0.2}{0.2} = 1$
- Confidence for {e}→{b,d}: $c({e} \rightarrow {b,d}) = \frac{s({b,d,e})}{s({e})} = \frac{0.2}{0.8} = 0.25$
...
- Support for {e}: $s({e}) = \frac{4}{5} = 0.8$
- Support for {b,d}: $s({b,d}) = \frac{5}{5} = 1$
- Support for {b,d,e}: $s({b,d,e}) = \frac{4}{5} = 0.8$

(d) Confidence for the association rules:

- Confidence for {b,d}→{e}: $c({b,d} \rightarrow {e}) = \frac{s({b,d,e})}{s({b,d})} = \frac{0.8}{1} = 0.8$
- Confidence for {e}→{b,d}: $c({e} \rightarrow {b,d}) = \frac{s({b,d,e})}{s({e})} = \frac{0.8}{0.8} = 1$
